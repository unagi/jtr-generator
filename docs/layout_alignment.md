...
## 対象ファイル
- `jtr-generator/assets/data/a4/rirekisho_layout.json`: 罫線・ラベル・データフィールドの絶対座標
- `jtr-generator/assets/data/a4/rules/label_alignment.json`: ラベル配置のルール/手動ブロック
- `jtr-generator/assets/data/a4/rules/field_alignment.json`: 入力データの配置ルール
- `jtr-generator/assets/data/a4/definitions/manual_bounds.json`: 手動で測定した境界座標
...
1. 罫線・ラベル・データフィールドの位置を `jtr-generator/assets/data/a4/rirekisho_layout.json` で調整
